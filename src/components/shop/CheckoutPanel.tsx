      ...
      <div className="container grid gap-10 py-16 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <div className="space-y-5">
          ...
          <p className="max-w-md text-sm leading-6 text-muted-foreground">
            Once submitted, you'll receive an order confirmation via email with
            delivery details.
          </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  We'll send an order confirmation email once your purchase is
                  processed.
                </p>
              </div>
            </div>
